...
#+seq_todo: TODO(t) DRAFT(d) OPEN(o) | PUBLISHED(p) DONE(D)
...
#+hugo: more
** TODO What's the saw about the best being the enemy of the good?
:PROPERTIES:
...
** DRAFT Emulating Ed Sheeran's Looper X in Loopy Pro
:PROPERTIES:
...
| Play     | Arming | Stop:Tap      | Play     | Arming    | Stop the clock, resetting the session[fn:14]                               |
