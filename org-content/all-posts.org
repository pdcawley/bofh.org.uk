...
** DRAFT Panning Overdubs in Loopy Pro
:PROPERTIES:
...
This is still a work in progress, but enough people expressed an interest when I showed this off in a "How Do You Loop?" chat with John Paul Music UK [point to top right] here.

I've added links to the plugin you need, the pandomiser preset, and a sample Loopy Pro project that uses it, in the description.
